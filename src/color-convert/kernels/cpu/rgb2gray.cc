...
bool rgb_2_gray_native(const unsigned char *input, unsigned char *output,
...
bool rgb_2_gray_parallel(const unsigned char *input, unsigned char *output,
                         int width, int height) {
...
bool rgb_2_gray_simd(const unsigned char *input, unsigned char *output,
                     int width, int height) {
